...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    ...
    mlflow.set_tracking_uri("http://ec2-35-172-221-238.compute-1.amazonaws.com:5000/")  # Replace with your MLflow tracking URI
    client = MlflowClient()
...
if __name__ == '__main__':
    app.run(debug=True, port=5000)  # Runs on port 5000 with debug mode; add host='0.0.0.0' for external access if needed
